...
<head>
    <title>Register</title>
        <link rel="stylesheet" href="{{ asset('frontend/login/fonts/material-icon/css/material-design-iconic-font.min.css') }}">
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{ asset('gambar/logo.jpg')}}" alt="sing up image"></figure>
